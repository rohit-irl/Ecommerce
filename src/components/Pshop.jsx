...
const Pshop = () => {
  ...
  const slideLeft = () => sliderRef.current?.scrollBy({ left: -250, behavior: "smooth" });
  const slideRight = () => sliderRef.current?.scrollBy({ left: 250, behavior: "smooth" });
      ...
      <div className="bg-[#f5ecff] p-6 rounded-md">
        <div className="flex flex-col lg:flex-row gap-6 items-center">
          ...
          <div className="bg-[#8A2BE2]/20 flex flex-col justify-center items-start text-left rounded-md p-6 w-full lg:w-1/3">
            <span
              className="bg-[#6D1D9C] text-white font-bold pl-4 pr-16 py-1 inline-block text-start"
              style={{
          ...
          <div className="relative flex-1 w-full rounded-md p-4 overflow-hidden">
            ...
            {showLeft && (
              <button
                onClick={slideLeft}
                className="absolute left-2 top-1/2 -translate-y-1/2 z-10 bg-[#629D23] text-white p-2 rounded-full shadow"
              >
                <ChevronLeft size={20} />
              </button>
            )}
            {showRight && (
              <button
                onClick={slideRight}
                className="absolute right-2 top-1/2 -translate-y-1/2 z-10 bg-[#629D23] text-white p-2 rounded-full shadow"
              >
            ...
            >
              {grocerys.map((val, index) => (
                <div
                  key={index}
                  className="relative min-w-[200px] p-3 flex flex-col bg-[#F5F6F7] rounded-md shadow-sm hover:shadow-md transition"
                >
                  {/* ❤️ Wishlist Button */}
                  <button
                  ...
                  <div className="flex justify-center items-center h-[120px] rounded-md">
                    <img
                      src={val.image}
                      alt="product"
                      className="h-35 py-2 object-contain"
                    />
                  </div>
                  ...
                  <div className="mt-auto flex justify-between items-center">
                    ...
                    <button className="flex items-center gap-1 border border-[#629D23] text-[#629D23] px-2 py-1 text-sm font-semibold rounded-sm hover:bg-[#629D23]/10 transition">
